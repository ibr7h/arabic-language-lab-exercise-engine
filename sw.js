const CACHE_VERSION = 'arabic-language-lab-exercise-engine-v5-2026-09-18-arabic-harakat';
const CORE = [
  './', './index.html', './manifest.webmanifest', './LICENSE.txt',
  './assets/css/tailwind.css', './assets/css/app.css',
  './assets/js/app.js', './assets/js/pwa.js',
  './assets/js/core/arabic-text.js', './assets/js/core/arabic-identity.js', './assets/js/core/ligature-engine.js', './assets/js/core/board-piece.js', './assets/js/core/sound-engine.js', './assets/js/core/confetti-lite.js',
